...
class ProductView(View):
    def get(self, request):
        ...
        RawFood = Product.objects.filter(category='RF')
...
def Rawfood(request, data=None):
    if data == None:
        Rawfood = Product.objects.filter(category='RF')
    return render(request, 'app/Rawfood.html', {'Rawfood': Rawfood})


def spices(request, data=None):
    if data == None:
        spices = Product.objects.filter(category='S')
    return render(request, 'app/spices.html', {'spices': spices})
