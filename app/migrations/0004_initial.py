...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('app', '0003_remove_customer_user_remove_orderplaced_customer_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('F', 'Fruits'), ('V', 'Vegetables'), ('RF', 'Raw Food'), ('S', 'Spices')], max_length=2)),
